...
namespace Tests
{
    public class TestThirstTimeSystem
    {
        ...
        public IEnumerator TestTimeSystemOneHour()
        {
            ...
            Entitas.Systems systems = new Feature("Time")
                ...
                .Add(new RedMoonRPG.Systems.TimeG.TimeThirstSystem(contexts));
            ...
            Assert.AreEqual(entityPlayer.thirst.value, 50);
        ...
        public IEnumerator TestTimeSystemTwoHour()
        {
            ...
            Assert.AreEqual(entityPlayer.thirst.value, 100);
