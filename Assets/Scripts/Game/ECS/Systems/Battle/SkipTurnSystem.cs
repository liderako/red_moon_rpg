...
namespace RedMoonRPG.Systems.Battle
{
    public class SkipTurnSystem : ReactiveSystem<BattleEntity>
    {
        ...
        protected override void Execute(List<BattleEntity> entities)
        {
            ...
            entities[0].battleList.battleAvatars[i].ReplaceActionPoint(0);
            DisplayAvailableGridSystem.BzeroCell(entities[0].battleList.battleAvatars[i].terrainGrid.value, entities[0].battleList.battleAvatars[i].pathDisplay.value);
