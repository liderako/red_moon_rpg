...
namespace WorldMap
{
    public class CameraFollowerMovementSystem : ReactiveSystem<GameEntity>
    {
        ...
        {
            return entity.isWorldMapMovement && _contexts.game.GetEntityWithName("Camera").isFreeCamera == false; // и тут проверка что если игрок все таки начал двигать мышкой то слежка прекратится за игроком.
        }
